...
#if WINAPI_FAMILY == WINAPI_FAMILY_APP
static ISwapChainBackgroundPanelNative *WINRT_SwapChainBackgroundPanelNative = NULL;
static Windows::Foundation::EventRegistrationToken WINRT_XAMLAppEventToken;
#endif

extern "C" void *
WINRT_GetSwapChainBackgroundPanelNative(void)
{
#if WINAPI_FAMILY == WINAPI_FAMILY_APP
    return WINRT_SwapChainBackgroundPanelNative;
#else
    return NULL;
#endif
}
...
extern "C" void
WINRT_DetachSwapChainBackgroundPanelNative(void)
{
#if WINAPI_FAMILY == WINAPI_FAMILY_APP
    WINRT_SwapChainBackgroundPanelNative = NULL;
#endif
}
...
bool SDL_WinRTInitXAMLApp(int (*mainFunction)(int, char **), void *backgroundPanelAsIInspectable)
{
    ...
    panelInspectable->QueryInterface(__uuidof(ISwapChainBackgroundPanelNative), (void **)&WINRT_SwapChainBackgroundPanelNative);
